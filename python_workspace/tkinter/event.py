...
class MyGui:
    ...
    def __init__(self):
        self.window = tk.Tk()
        self.label = tk.Label(self.window , text="Cloudy : " , font=("Arial" , 18))
        self.label.pack(padx=10 , pady=10)
        self.checkbox_yes= tk.Checkbutton(self.window , text="yes" , font=("Arial" , 16)  )
        self.checkbox.pack(padx=10 , pady=10)
        self.checkbox_no= tk.Checkbutton(self.window , text="no" , font=("Arial" , 16)  )
        self.checkbox.pack(padx=10 , pady=10)
